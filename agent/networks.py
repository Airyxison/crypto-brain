...
---------------------------------------------
Actor:   state (19) → action logits (5) → softmax policy
Critic:  state (19) → Q values for all 5 actions
...
STATE_DIM  = 19  # 17-dim base + vol_flow_30 [17] + vol_flow_240 [18] (Barney v1, 2026-04-25)
ACTION_DIM = 5
